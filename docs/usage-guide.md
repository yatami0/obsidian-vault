...
```
10_daily/YYYY/MM/YYYY-MM-DD.md
```

例: 2026年1月17日の日報
```
10_daily/2026/01/2026-01-17.md
```
...
| 設定項目 | 値 | 説明 |
|---------|-----|------|
| Date format | `YYYY-MM-DD` | ファイル名の形式 |
...
- ファイル名が正しい形式か確認: `YYYY-MM-DD.md`
- ファイルパスが正しいか確認: `10_daily/YYYY/MM/`
- GitHubにpushされているか確認

### 23:00までにpushする

自動送信は毎日23:00（JST）に実行されます。

**重要**: 送信対象は **当日の日付のファイル** です。
- 例: 1月26日 23:00 → `10_daily/2026/01/2026-01-26.md` が送信される
- 過去の日付や未来の日付のファイルは送信されません
- 当日の日報を23:00までにGitHubにpushしてください
